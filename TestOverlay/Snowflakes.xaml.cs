...
namespace TestOverlay
{
    ...
    public partial class Snowflakes : Window
    {
        ...
        public Snowflakes()
        {
            ...
            NOTIFYICON.ShowBalloonTip("hi", "im down here!", Hardcodet.Wpf.TaskbarNotification.BalloonIcon.None);
        ...
        private void generateNewPictureFlake()
        {
            //old flakes revamp
        ...
        private void SpeedUpSanta(object sender, RoutedEventArgs e)
        {
            santaSpeed++;
            if (santaSpeed > 1)
            {
            ...
            speedLabel.Content = santaSpeed.ToString();
            animation.SpeedRatio = santaSpeed;
            santaImg.BeginAnimation(Window.LeftProperty, animation);
        }

        private void SlowDownSanta(object sender, RoutedEventArgs e)
        {
            santaSpeed--;
            if (santaSpeed == 1)
            {
